...
type externCtx interface {
	...
	GetCtxInfo(interface{}, interface{}) (interface{}, error)
}
...
func (c *nativeCtx) GetCtxInfo(obj interface{}) (interface{}, error) {
	if s, ok := obj.(string); ok && s == "ContextRPC" {
		return c.c, nil
	}
	return c.ctx.GetCtxInfo(c.c, obj)
}
...
func (c *ginCtx) GetCtxInfo(obj interface{}) (interface{}, error) {
	if s, ok := obj.(string); ok && s == "ContextRPC" {
