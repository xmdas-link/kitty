...
type FormCreateUser struct {
	Name               *string  `json:"-" kitty:"param:user.name;getter:vf(len(this)>0,'name required')"`
	Age                *string  `json:"-" kitty:"param:user.age;"`
	Department         *string  `json:"-" kitty:"param:user.department;"`
	Salary             *float64 `json:"-" kitty:"param:user.salary;getter:vf(this!=nil&&this>0.0,'salary is zero.')"`
...
type FormUpdateUser struct {
	ID                 *uint32 `json:"-" kitty:"param:user.id;getter:vf(this!=nil&&this>0,'please input id')"`
...
type FormUser struct {
	...
	ID   *uint32 `json:"-" kitty:"param:user.id;getter:vf(this!=nil||name!=nil,'id or name required.')"`
	Name *string `json:"-" kitty:"param:user.name;"`
	User User    `json:"-" kitty:"master"`
}
